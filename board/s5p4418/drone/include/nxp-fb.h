...
extern int drone_setup_lcd_by_id(int id);
extern int drone_setup_lcd_by_name(char *name);
extern struct nxp_lcd *drone_get_lcd(void);
extern const char *drone_get_lcd_name(void);
extern int drone_get_lcd_density(void);
extern enum lcd_format drone_get_lcd_format(void);
